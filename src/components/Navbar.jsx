...
const Navbar = ({ loggedUser }) => {
  ...
  return (<nav className={`${classes.navbar} navbar navbar-expand-lg navbar-light fixed-nav-bar`} >
    <div className="container-fluid navbar-inner">
      <Link className="navbar-brand" to="/"><img src={logo} height="50px" width="200px" style={{ marginLeft: "-40px" }} /></Link>
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span className="navbar-toggler-icon"></span>
      </button>
      <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul className={`navbar-nav mb-2 mb-lg-0 ml-auto my-auto ${classes.navv}`}>
