   ...
   <Switch />
    <div className="container py-5 h-100">
      ...
      >
        ...
        <div className={`${classes.card} rounded-3`}>
            <Link to="/">
              <img
                src={logo}
                className="w-100"
            ...
            <div className="card-body p-4 p-md-5">
              <h3 className="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2"  style={{  color:"var(--text-color)"}}>
                Edit your profile
              </h3>
              ...
              <form className="px-md-2" action="/edit" onSubmit={formSubmitHandler}>
                ...
                <div className={`${classes.row} row`}>
                  <div className="col-md-6 mb-3">
                    <div className="form-outline datepicker">
                      <label htmlFor="age"   style={{  color:"var(--text-color)"}}>Age:</label>
                      <input
                        type="number"
                        id="age"
                        name="age"
                ...
                >
                  ...
                  >
                    <label htmlFor="gender"  style={{  color:"var(--text-color)"}}>Gender</label>
                    <select
                      name="gender"
                      id="gender"
                      className="select"
                ...
                <div className={`${classes.row} row`}>
                  <div className="col-md-8 mb-3">
                  <i  style={{  color:"var(--text-color)"}}>Choose an image for your profile picture</i>
